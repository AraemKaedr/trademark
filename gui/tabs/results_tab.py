...
class ResultsTab(QWidget):
    ...
    def show_results(self, query_path: str, resnet_dist, resnet_idx, yolo_dist, yolo_idx):
        ...
        vbox.addWidget(lbl)
        vbox.addWidget(QLabel(f"<b>Оригинальность:</b> {1}%"))
        ...
        self.status.setText(f"Показано топ-{max_results} результатов сравнения ResNet50 и YOLO")